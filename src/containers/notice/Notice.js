      ...
      <div className="video-responsive">
        ...
        <div className="background-overlay">
          <div className="background-overlay-content">
            <h1>About Us</h1>
            <div>
              TRACK FARM has an ICT Conversion Technology in Machine-Learning,
              Smart farm biz, and cloud platform.
            </div>
          ...
          <div className="content-divider-content">
            <div>
              <Link className="news-link" to="/notice">
                ...
                <p>
                  [NEWS] (주)트랙팜, 제 26회 COMMAX 벤처창업 경진대회 우수상
                  수상
                </p>
                <span>Track Farm</span>
              </Link>
            </div>
            <div>
              <Link className="news-link" to="/notice">
                ...
                <p>
                  [NEWS] 한양대학교 기술지주회사 자회사 협약 체결, 초기 시드
                  투자 유치
                </p>
                <span>Track Farm</span>
              </Link>
            ...
            <div>
              <Link className="news-link" to="/notice">
                ...
                <p>[NEWS] 2022년 연수구 4차산업혁명 청년창업지원 사업 선정</p>
                <span>Track Farm</span>
              </Link>
            </div>
          </div>
          <div className="content-divider-content">
            ...
            <div>
              <Link className="news-link" to="/notice">
                ...
                <p>
                  [NEWS] KOAT 한국농업기술진흥원 농식품벤처육성지원 선정 최대
                  5년 지원
                </p>
                <span>Track Farm</span>
              </Link>
